  ...
  module R5
    class NamingSystem < Model
      ...
      METADATA = {
        ...
        'type' => {'valid_codes'=>{'http://terminology.hl7.org/CodeSystem/v2-0203'=>['AC', 'ACSN', 'AIN', 'AM', 'AMA', 'AN', 'ANC', 'AND', 'ANON', 'ANT', 'APRN', 'ASID', 'BA', 'BC', 'BCFN', 'BCT', 'BR', 'BRN', 'BSNR', 'CAAI', 'CC', 'CONM', 'CY', 'CZ', 'DC', 'DCFN', 'DDS', 'DEA', 'DFN', 'DI', 'DL', 'DN', 'DO', 'DP', 'DPM', 'DR', 'DS', 'DSG', 'EI', 'EN', 'ESN', 'FDR', 'FDRFN', 'FGN', 'FI', 'FILL', 'GI', 'GIN', 'GL', 'GN', 'HC', 'IND', 'JHN', 'LACSN', 'LANR', 'LI', 'L&I', 'LN', 'LR', 'MA', 'MB', 'MC', 'MCD', 'MCN', 'MCR', 'MCT', 'MD', 'MI', 'MR', 'MRT', 'MS', 'NBSNR', 'NCT', 'NE', 'NH', 'NI', 'NII', 'NIIP', 'NNxxx', 'NP', 'NPI', 'OBI', 'OD', 'PA', 'PC', 'PCN', 'PE', 'PEN', 'PGN', 'PHC', 'PHE', 'PHO', 'PI', 'PIN', 'PLAC', 'PN', 'PNT', 'PPIN', 'PPN', 'PRC', 'PRN', 'PT', 'QA', 'RI', 'RN', 'RPH', 'RR', 'RRI', 'RRP', 'SAMN', 'SB', 'SID', 'SL', 'SN', 'SNBSN', 'SNO', 'SP', 'SR', 'SRX', 'SS', 'STN', 'TAX', 'TN', 'TPR', 'TRL', 'U', 'UDI', 'UPIN', 'USID', 'VN', 'VP', 'VS', 'WC', 'WCN', 'WP', 'XV', 'XX']}, 'type'=>'CodeableConcept', 'path'=>'NamingSystem.type', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'preferred', 'uri'=>'http://hl7.org/fhir/ValueSet/namingsystem-identifier-system-type'}},
