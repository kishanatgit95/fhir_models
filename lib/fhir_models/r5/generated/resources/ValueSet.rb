    ...
    class ValueSet < Model
      ...
      class Compose < Model
        ...
        class Include < Model
          ...
          METADATA = {
            ...
            'copyright' => {'type'=>'string', 'path'=>'Include.copyright', 'min'=>0, 'max'=>1}
          }
      ...
      class Scope < Model
        ...
        METADATA = {
          ...
          'inclusionCriteria' => {'type'=>'string', 'path'=>'Scope.inclusionCriteria', 'min'=>0, 'max'=>1},
          'exclusionCriteria' => {'type'=>'string', 'path'=>'Scope.exclusionCriteria', 'min'=>0, 'max'=>1}
        }

        attr_accessor :id                # 0-1 string
        attr_accessor :extension         # 0-* [ Extension ]
        attr_accessor :modifierExtension # 0-* [ Extension ]
        attr_accessor :inclusionCriteria # 0-1 string
        attr_accessor :exclusionCriteria # 0-1 string
      end
