  ...
  module R4
    ...
    class StructureDefinition
      ...
      def compatible?(another_definition)
        ...
        @finding = FHIR::R4::StructureDefinitionFinding.new
        ...
        if !(another_definition.is_a? FHIR::R4::StructureDefinition)
      ...
      def add_missing_elements(_name, missing_paths, elements, base_elements)
        ...
        missing_paths.each do |path|
          ...
          unless elem.nil?
            # _DEEP_ copy
            elements << FHIR::R4::ElementDefinition.from_fhir_json(elem.to_fhir_json)
            next
          end
          ...
          type_elements.map! do |e| # {|e| FHIR::ElementDefinition.from_fhir_json(e.to_fhir_json) }
            FHIR::R4::ElementDefinition.from_fhir_json(e.to_fhir_json)
          end
          # Fix path names
